          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li
                  class="bi"
                  v-if="changeIndex == 10 && listByCodePs1.length >= 11"
                >
                ...
                <li
                  class="bi"
                  v-else-if="changeIndex != 10 && listByCodePs1.length >= 11"
                >
            ...
            <li>
              <span>专利类型 :</span>
              <ul>
                <li :class="zhuanliA == 0 ? 'active' : ''" @click="open3(0)">
                  全部
                </li>
                <li
                  v-for="(item, zhuanliindex) in zhuanli"
                  :class="zhuanliA == zhuanliindex + 1 ? 'active' : ''"
                  @click="open3(zhuanliindex + 1)"
                >
                  {{ item }}
                </li>
              </ul>
            ...
            <li>
              <span>交易类型 :</span>
              <ul>
                <li :class="leixingA == 0 ? 'active' : ''" @click="open2(0)">
                  全部
                </li>
                <li
                  v-for="(item, leixingindex) in leixing"
                  :class="leixingA == leixingindex + 1 ? 'active' : ''"
                  @click="open2(leixingindex + 1)"
                >
                  {{ item }}
                </li>
              </ul>
...
export default {
  ...
  beforeCreate () {
    this.$store.dispatch('setNavName', '专利交易')
  },
  data () {
    return {
      listByCodePs2: [],
  ...
  methods: {
    ...
    showProductInit (param) {
      var params = {
        ...
        patentType: this.zhuanliA,
        tradeType: this.leixingA,
        resourceCategoryId: this.changeactive,
        productClassId: Number(28)
      }
