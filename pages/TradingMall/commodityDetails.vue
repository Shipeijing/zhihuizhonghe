      ...
      <div class="shopInfo">
        <div class="leftb">
          ...
          ><a v-on:click="goProductsList(i.id, i.name)">{{ i.name }}</a>
            > </span><span>{{ productInfo.title }}</span>
        </div>
        <div class="rightb">
          <div class="shopType">{{ shopInfo.type }}</div>
          <div
            class="shopName"
            v-on:click="goShopDetail(shopInfo.id)"
          >
            {{ shopInfo.shopName }}
          </div>
          <div class="online">
    ...
    <div class="main">
      ...
      <div class="right">
        ...
        <section class="rightShop">
          <ul>
            <li>
              <span>智全知识产权</span><img
                @click="goShopDetail(shopId)"
                :src="$store.state.baseImgUrl + shopLogo"
                alt=""
              />
            </li>
            <li>
              ...
              <ul>
                <li
                  ...
                  @click="goGoodsDetail(productId, shopId)"
                >
                  {{ item.title }}
                  <p>￥{{ item.price }}</p>
                </li>
      ...
      <div class="introduce">
        <ul class="nav">
          <li
            :class="activeBar == 4 ? 'active' : ''"
            @click="shopintroduce(4)"
          >
            全部展示
          </li>
          <li
            :class="activeBar == 1 ? 'active' : ''"
            @click="shopintroduce(1)"
          >
            商品介绍
          </li>
          <li
            :class="activeBar == 2 ? 'active' : ''"
            @click="shopintroduce(2)"
          >
            商品评价（{{ rec }}）
          </li>
          <li
            :class="activeBar == 3 ? 'active' : ''"
            @click="shopintroduce(3)"
          >
            安全保障
          </li>
        </ul>
        <div
          class="shopContent"
          v-show="activeBar == 1 || activeBar == 4"
        >
          <h1>商品介绍</h1>
          <table>
            <tr>
        ...
        <div
          class="shopContent"
          v-show="activeBar == 2 || activeBar == 4"
        >
          <h1>商品评价</h1>
          <div class="shopContent-d1">
            ...
            <ul class="shopContent-d1-nav">
              ...
              <li
                :class="changenav == 4 ? 'changenav' : ''"
                @click="change(4)"
              >
                晒图（{{ ima }}）
              </li>
              <li
                :class="changenav == 3 ? 'changenav' : ''"
                @click="change(3)"
              >
                好评（{{ pra }}）
              </li>
              <li
                :class="changenav == 2 ? 'changenav' : ''"
                @click="change(2)"
              >
                中评（{{ ave }}）
              </li>
              <li
                :class="changenav == 1 ? 'changenav' : ''"
                @click="change(1)"
              >
                差评（{{ bad }}）
              </li>
