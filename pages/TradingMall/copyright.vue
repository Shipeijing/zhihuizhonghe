        ...
        <div class="Mall-d1">
          <ul>
            <li>
              ...
              <ul>
                <li
                  :class="changeactive === null ? 'active' : ''"
                  @click="open(null)"
                >
                  全部
                </li>
                <li
                  ...
                  :class="changeactive === item.id ? 'active' : ''"
                  @click="open(item.id)"
            ...
            <li>
              <span>交易类型 :</span>
              <ul>
                <li :class="hanziA === 0 ? 'active' : ''" @click="open2(0)">
                  全部
                </li>
                <li
                  v-for="(item, hanziindex) in leixing"
                  :class="hanziA == hanziindex + 1 ? 'active' : ''"
                  @click="open2(hanziindex + 1)"
                >
                  {{ item }}
                </li>
              </ul>
...
export default {
  ...
  beforeCreate () {
    this.$store.dispatch('setNavName', '版权交易')
  },
  data () {
    return {
      changeIndex: 12,
